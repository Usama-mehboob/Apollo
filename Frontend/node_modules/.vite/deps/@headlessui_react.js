...
function r(e7) {
  ...
  if ("string" == typeof e7 || "number" == typeof e7) n13 += e7;
    ...
    var o18 = e7.length;
    for (t14 = 0; t14 < o18; t14++) e7[t14] && (f20 = r(e7[t14])) && (n13 && (n13 += " "), n13 += f20);
  } else for (f20 in e7) e7[f20] && (n13 && (n13 += " "), n13 += f20);
  return n13;
}
function clsx() {
  for (var e7, t14, f20 = 0, n13 = "", o18 = arguments.length; f20 < o18; f20++) (e7 = arguments[f20]) && (t14 = r(e7)) && (n13 && (n13 += " "), n13 += t14);
  return n13;
}
...
function U() {
  let r15 = (0, import_react42.useRef)([]), n13 = (0, import_react42.useCallback)((e7) => {
    for (let a15 of r15.current) a15 != null && (typeof a15 == "function" ? a15(e7) : a15.current = e7);
  }, []);
  return (...e7) => {
    if (!e7.every((a15) => a15 == null)) return r15.current = e7, n13;
  };
}
function A(...r15) {
  return r15.every((n13) => n13 == null) ? void 0 : (n13) => {
    for (let e7 of r15) e7 != null && (typeof e7 == "function" ? e7(n13) : e7.current = n13);
  };
}
function N(...r15) {
  var a15;
  if (r15.length === 0) return {};
  if (r15.length === 1) return r15[0];
  let n13 = {}, e7 = {};
  for (let s16 of r15) for (let t14 in s16) t14.startsWith("on") && typeof s16[t14] == "function" ? ((a15 = e7[t14]) != null || (e7[t14] = []), e7[t14].push(s16[t14])) : n13[t14] = s16[t14];
...
function e2(i13 = {}, s16 = null, t14 = []) {
  for (let [r15, n13] of Object.entries(i13)) o6(t14, f3(s16, r15), n13);
  return t14;
}
function f3(i13, s16) {
...
function o6(i13, s16, t14) {
  if (Array.isArray(t14)) for (let [r15, n13] of t14.entries()) o6(i13, f3(s16, r15.toString()), n13);
...
function ie(T12, h7) {
  let C7 = (0, import_react46.useId)(), k5 = u5(), x6 = a3(), { id: g8 = k5 || `headlessui-checkbox-${C7}`, disabled: o18 = x6 || false, autoFocus: s16 = false, checked: E11, defaultChecked: v7, onChange: P7, name: d16, value: D9, form: R7, indeterminate: l16 = false, ...A7 } = T12, r15 = l2(v7), [a15, t14] = T(E11, P7, r15 != null ? r15 : false), F6 = I2(), K4 = G(), _6 = p(), [p8, c13] = (0, import_react52.useState)(false), m13 = o4(() => {
    ...
    if (r15 !== void 0) return t14 == null ? void 0 : t14(r15);
  }, [t14, r15]);
  ...
  constructor(opts) {
    ...
    this.getMeasurements = memo(
      ...
      ({ count: count2, paddingStart, scrollMargin, getItemKey }, itemSizeCache) => {
        ...
        for (let i13 = min; i13 < count2; i13++) {
...
function P5(e7, r15, { sorted: t14 = true, relativeTo: u17 = null, skipElements: o18 = [] } = {}) {
  ...
  let n13 = (() => {
    ...
    if (r15 & 1) return 0;
    if (r15 & 2) return Math.max(0, l16.indexOf(u17)) - 1;
    if (r15 & 4) return Math.max(0, l16.indexOf(u17)) + 1;
    if (r15 & 8) return l16.length - 1;
    throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last");
  })(), M7 = r15 & 32 ? { preventScroll: true } : {}, m13 = 0, d16 = l16.length, i13;
  do {
    if (m13 >= d16 || m13 + d16 <= 0) return 0;
    let s16 = x6 + m13;
    if (r15 & 16) s16 = (s16 + d16) % d16;
    else {
      if (s16 < 0) return 3;
      if (s16 >= d16) return 1;
    }
...
function a8(e7, r15, n13 = () => ({ containers: [] })) {
  ...
  return n(() => {
    if (!(!e7 || !r15)) return a7.dispatch("PUSH", e7, n13), () => a7.dispatch("POP", e7, n13);
  }, [r15, e7]), i13;
}
...
function ve({ children: e7, enabled: t14 = true }) {
  ...
  let { refs: b7, floatingStyles: $5, context: g8 } = useFloating2({ open: o18, placement: s16 === "selection" ? f20 === "center" ? "bottom" : `bottom-${f20}` : f20 === "center" ? `${s16}` : `${s16}-${f20}`, strategy: "absolute", transform: false, middleware: [offset2({ mainAxis: s16 === "selection" ? 0 : C7, crossAxis: M7 }), shift2({ padding: p8 }), s16 !== "selection" && flip2({ padding: p8 }), s16 === "selection" && P7 ? inner({ ...P7, padding: p8, overflowRef: c13, offset: a15, minItemsVisible: q, referenceOverflowThreshold: p8, onFallbackChange(h7) {
    var W6, k5;
    if (!h7) return;
  ...
  } }) : null, size2({ padding: p8, apply({ availableWidth: h7, availableHeight: d16, elements: T12 }) {
...
function D4(p8) {
  let r15 = a9(), l16 = (0, import_react76.useContext)(v4), e7 = n8(p8), [o18, n13] = (0, import_react76.useState)(() => {
    var t14;
    if (!r15 && l16 !== null) return (t14 = l16.current) != null ? t14 : null;
...
var Oo = { [1](o18) {
  ...
  var r15, e7;
  if ((r15 = o18.dataRef.current) != null && r15.disabled || o18.comboboxState === 0) return o18;
  ...
  var s16, d16, i13;
  if ((s16 = o18.dataRef.current) != null && s16.virtual) return { ...o18, options: [...o18.options, r15.payload] };
  ...
  var t14;
  if ((t14 = o18.dataRef.current) != null && t14.virtual) return { ...o18, options: o18.options.filter((c13) => c13.id !== r15.id) };
  let e7 = Te(o18, (c13) => {
  ...
  var t14, c13;
  if (o18.virtual === null) return { ...o18, virtual: { options: r15.options, disabled: (t14 = r15.disabled) != null ? t14 : () => false } };
  if (o18.virtual.options === r15.options && o18.virtual.disabled === r15.disabled) return o18;
...
function Co(o18) {
  ...
  return m13.length === 0 ? null : import_react77.default.createElement(Le.Provider, { value: s16 }, import_react77.default.createElement("div", { style: { position: "relative", width: "100%", height: `${s16.getTotalSize()}px` }, ref: (n13) => {
    if (n13) {
      if (typeof process != "undefined" && process.env.JEST_WORKER_ID !== void 0 || r15.activationTrigger === 0) return;
...
function j6({ defaultContainers: o18 = [], portals: r15, mainTreeNodeRef: u17 } = {}) {
  ...
  let t14 = (0, import_react80.useRef)((f20 = u17 == null ? void 0 : u17.current) != null ? f20 : null), l16 = n8(t14), c13 = o4(() => {
    ...
    if (r15 != null && r15.current) for (let e7 of r15.current) n13.push(e7);
...
function p7(e7, r15 = true) {
  ...
  if (n(() => {
    ...
    l16 && (t14.current = l16);
  }, [r15]), e7.current == null || !r15 || e7.current === document.activeElement) return false;
...
function s13(c13) {
  ...
  return o4(() => {
    ...
    if (t14.current === u17) return r15.current;
...
var Ot = { [1](e7) {
  ...
  if (a15.focus === c6.Specific) return { ...o18, activeOptionIndex: e7.options.findIndex((r15) => r15.id === a15.id) };
...
function St(e7, a15) {
  ...
  let o18 = W3("Listbox.Button"), n13 = $2("Listbox.Button"), u17 = (0, import_react46.useId)(), T12 = u5(), { id: O3 = T12 || `headlessui-listbox-button-${u17}`, disabled: i13 = o18.disabled || false, autoFocus: l16 = false, ...t14 } = e7, r15 = y(o18.buttonRef, a15, ye()), R7 = Fe(), c13 = p(), d16 = o4((p8) => {
    ...
    if (r5(p8.currentTarget)) return p8.preventDefault();
...
function At2(e7, a15) {
  ...
  let x6 = o4((s16) => {
    switch (M7.dispose(), s16.key) {
      case o8.Space:
        if (t14.searchQuery !== "") return s16.preventDefault(), s16.stopPropagation(), r15.search(s16.key);
      case o8.Enter:
...
function ht2(e7, a15) {
  ...
  n(() => {
    if (l16.__demoMode || l16.listboxState !== 0 || !r15 || l16.activationTrigger === 0) return;
    let x6 = o2();
...
var ke3 = { [1](e7) {
  ...
  if (a15.focus === c6.Nothing) return { ...r15, activeItemIndex: null };
  if (a15.focus === c6.Specific) return { ...r15, activeItemIndex: e7.items.findIndex((l16) => l16.id === a15.id) };
  if (a15.focus === c6.Previous) {
    ...
    if (l16 !== null) {
      ...
      if (c13 !== null) {
        ...
        if (((d16 = g8.current) == null ? void 0 : d16.previousElementSibling) === m13.current || ((n13 = m13.current) == null ? void 0 : n13.previousElementSibling) === null) return { ...r15, activeItemIndex: c13 };
      }
    }
  } else if (a15.focus === c6.Next) {
    let l16 = e7.activeItemIndex;
    if (l16 !== null) {
      ...
      if (c13 !== null) {
        let m13 = e7.items[c13].dataRef.current.domRef;
        if (((u17 = g8.current) == null ? void 0 : u17.nextElementSibling) === m13.current || ((t14 = m13.current) == null ? void 0 : t14.nextElementSibling) === null) return { ...r15, activeItemIndex: c13 };
      }
    }
  }
...
function Qe(e7, a15) {
  ...
  let r15 = (0, import_react46.useId)(), { id: s16 = `headlessui-menu-button-${r15}`, disabled: o18 = false, autoFocus: p8 = false, ...d16 } = e7, [n13, u17] = w8("Menu.Button"), t14 = Fe(), l16 = y(n13.buttonRef, a15, ye()), g8 = p(), c13 = o4((f20) => {
    ...
    if (r5(f20.currentTarget)) return f20.preventDefault();
...
function lt2(t14, a15) {
  ...
  let [s16] = (0, import_react98.useState)(() => Symbol()), y9 = y(P7, a15, ye(), n13 ? null : (r15) => {
    if (r15) l16.buttons.current.push(s16);
    else {
...
function st2(t14, a15) {
  let u17 = (0, import_react46.useId)(), { id: C7 = `headlessui-popover-overlay-${u17}`, ...T12 } = t14, [{ popoverState: S8 }, i13] = ne("Popover.Overlay"), l16 = y(a15), f20 = u13(), e7 = (() => f20 !== null ? (f20 & d9.Open) === d9.Open : S8 === 0)(), P7 = o4((m13) => {
    if (r5(m13.currentTarget)) return m13.preventDefault();
    i13({ type: 1 });
...
function Ue2(o18, t14) {
  let e7 = (0, import_react46.useId)(), a15 = a3(), { id: O3 = `headlessui-radiogroup-${e7}`, value: m13, form: P7, name: i13, onChange: f20, by: c13, disabled: p8 = a15 || false, defaultValue: I5, ...y9 } = o18, T12 = u9(c13), [v7, C7] = (0, import_react99.useReducer)(Fe2, { options: [] }), n13 = v7.options, [U5, h7] = z(), [D9, L9] = U2(), A7 = (0, import_react99.useRef)(null), M7 = y(A7, t14), l16 = l2(I5), [s16, _6] = T(m13, f20, l16), R7 = (0, import_react99.useMemo)(() => n13.find((r15) => !r15.propsRef.current.disabled), [n13]), b7 = (0, import_react99.useMemo)(() => n13.some((r15) => T12(r15.propsRef.current.value, s16)), [n13, s16]), d16 = o4((r15) => {
    var u17;
    if (p8 || T12(r15, s16)) return false;
...
function De4(n13, o18) {
  ...
  let p8 = (0, import_react46.useId)(), f20 = u5(), b7 = a3(), { id: h7 = f20 || `headlessui-switch-${p8}`, disabled: t14 = b7 || false, checked: c13, defaultChecked: T12, onChange: y9, name: a15, value: u17, form: F6, autoFocus: d16 = false, ...k5 } = n13, w10 = (0, import_react101.useContext)(S7), _6 = (0, import_react101.useRef)(null), H10 = y(_6, o18, w10 === null ? null : w10.setSwitch), l16 = l2(T12), [s16, r15] = T(c13, y9, l16 != null ? l16 : false), M7 = p(), [P7, E11] = (0, import_react101.useState)(false), D9 = o4(() => {
    ...
    if (l16 !== void 0) return r15 == null ? void 0 : r15(l16);
  }, [r15, l16]);
...
var Le4 = { [0](e7, r15) {
  ...
  if (e7.tabs.includes(r15.tab)) return e7;
...
function l15(r15) {
  let e7 = { called: false };
  return (...t14) => {
    if (!e7.called) return e7.called = true, r15(...t14);
  };
}
...
function He5(t14, n13) {
  ...
  l10();
  let f20 = u13();
  if (r15 === void 0 && f20 !== null && (r15 = (f20 & d9.Open) === d9.Open), r15 === void 0) throw new Error("A <Transition /> is used but it is missing a `show={true | false}` prop.");
